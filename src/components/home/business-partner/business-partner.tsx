...
export function BusinessPartnerSection() {
  ...
  const benefits = [
    {
      ...
      desc: "Access direct course rates and seamless settlement processing for candidates.",
    },
    {
      icon: LayoutDashboard,
      title: "Dedicated Partner Dashboard",
      desc: "Track seafarer referrals, course enrollments, and settlements in real-time.",
    },
    {
      icon: Megaphone,
      title: "Marketing & Training Support",
      desc: "Get access to promotional materials and operational training.",
    },
    {
      icon: Globe2,
      title: "Nationwide & Global Opportunities",
      desc: "Expand your reach with our wide network of shipping partners.",
    },
  ];
  ...
  return (
    <section
      id="partnership"
      className={`py-24 relative overflow-hidden ${isDark ? "bg-[#050a14]" : "bg-slate-50"}`}
    >
      {/* Background elements */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <ScrollReveal>
              <div className="mb-8">
                ...
                <p
                  className={`text-base leading-relaxed ${isDark ? "text-slate-400" : "text-slate-650"}`}
                >
                  Join our trusted network of Maritime Partners and grow your
                  maritime business with us. Refer seafarers, manage candidate
                  enrollments, and expand your professional network.
                </p>
              </div>
            </ScrollReveal>
            ...
            <div className="space-y-6">
              {benefits.map((benefit, idx) => (
                <ScrollReveal key={idx} delay={idx * 100}>
                  <div
                    className={`flex gap-4 p-5 rounded-2xl border transition-all duration-300 hover:scale-[1.02] ${
                      isDark
                  ...
                  >
                    ...
                    <div>
                      <h4
                        className={`font-bold mb-1 ${isDark ? "text-slate-200" : "text-slate-800"}`}
                      >
                        {benefit.title}
                      </h4>
                      <p
          ...
          <ScrollReveal delay={300}>
            <div
              className={`p-8 md:p-10 rounded-3xl border backdrop-blur-xl relative overflow-hidden flex flex-col justify-between min-h-[380px] ${
                isDark
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <h3
                  className={`text-2xl font-black tracking-tight leading-snug ${isDark ? "text-white" : "text-slate-900"}`}
                >
                  Grow Your Placement Network With Us
                </h3>

                <p
                  className={`text-sm leading-relaxed ${isDark ? "text-slate-400" : "text-slate-650"}`}
                >
                  Become an authorized Maritime Partner of Hari Om Thalassic.
                  Connect with premium maritime opportunities, access our
                  training portals, and refer seafarers with automated tracking.
                </p>
              </div>
