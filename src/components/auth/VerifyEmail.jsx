...
const VerifyEmail = () => {
  ...
  const [userEmail, setUserEmail] = useState('user@example.com'); // Default email or get from props/context
    ...
    <div className="min-h-screen w-full relative font-josefin"
      ...
      <div className="min-h-screen w-full flex items-center justify-center px-4 py-4">
        ...
        >
          ...
          {/* Progress */}
          <VerificationProgress currentStep="email" />

          {/* Verification Section */}
          <div className="text-center mb-6">
            <h3 className="text-lg font-medium mb-2 text-gray-800">Verify Your Email</h3>
