    ...
    <main className="p-8">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-xl font-semibold text-gray-900">Documentation Administrator - DG Approved</h1>
              </div>
            ...
            {/* Task List Section */}
            <div className="mb-8">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Task List - DG Documentation Administrator</h2>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-gray-900">DG Documentation Overview</h2>
