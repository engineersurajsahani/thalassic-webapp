...
export const mockCoursesCatalog = [
  ...
  },
  {
    id: "c6",
    code: "STCW-ERM",
    name: "Engine Room Resource Management (ERM)",
    ...
    documents: [
      {
        ...
        previewUrl: "/mock-pdf-placeholder.png",
      },
      {
        id: "doc2",
        name: "Seaman Book (CDC)",
        type: "CDC",
        status: "Approved",
  ...
  },
  {
    ...
    documents: [
      ...
      },
      {
        ...
        previewUrl: "/mock-pdf-placeholder.png",
        rejectionReason:
          "Medical certificate format not standard or stamp missing.",
      },
    ],
    seaService: [],
  },
    ...
    messages: [
      {
        ...
        text: "We need to enroll Capt. Rajesh in the Bridge Resource Management refresher course today. However, the system is showing registration full. Please assist immediately as he sails in 5 days.",
      ...
      },
      {
        ...
        text: "Hello! I am looking into this. We will check with the training center to see if we can accommodate an extra slot for Capt. Rajesh due to his upcoming sign-on date.",
    ...
    messages: [
      {
        id: "m3",
        sender: "Company Administrator",
        text: "The Second Engineer CoC uploaded by Sandeep Nair has been pending verification for over 3 days. Is there an issue with the copy?",
      ...
      },
      {
        id: "m4",
        sender: "Support Agent",
        text: "Apologies for the delay. We are waiting on a response from the Indian DG Shipping online portal to verify the authenticity code. We should have it cleared by tomorrow.",
    ...
    messages: [
      {
        id: "m5",
        sender: "Company Administrator",
        text: "We recently acquired a new container vessel, the 'Thalassic Breeze'. Can we get this added to our list of eligible vessels for sea service logs?",
      ...
      },
      {
        id: "m6",
        sender: "Support Agent",
        text: "This has been added to our database. You can now select 'Thalassic Breeze' when filing new sea service records.",
...
export const mockRecentActivities: ActivityLog[] = [
  {
    ...
    activity: "Completed STCW-GMDSS certification",
  ...
  },
  {
    ...
    activity: "Uploaded new Passport document",
  ...
  },
  {
    ...
    activity: "Submitted Chief Mate CoC for verification",
    timestamp: "1 day ago",
    type: "document",
  },
  {
    ...
    activity: "Requested course renewal for STCW-BST",
  ...
  },
  {
    ...
    activity: "Signed on Thalassic Safety as Safety Officer",
...
export const mockNotifications: NotificationAlert[] = [
  {
    id: "nt1",
    message:
      "Medical Certificate for Capt. Rajesh Kumar is expiring in 45 days.",
    type: "warning",
    timestamp: "1 hour ago",
  },
  {
    id: "nt2",
    message: "New support ticket TCK-102 created for urgent course enrollment.",
    type: "info",
    timestamp: "3 hours ago",
  },
  {
    id: "nt3",
    message: "Passport verification for Sandeep Nair is pending.",
    type: "warning",
    timestamp: "1 day ago",
  },
  {
    id: "nt4",
    message:
      "Course compliance for Thalassic Webapp is at 84% (+2.4% this week).",
    type: "success",
    timestamp: "2 days ago",
  },
];
...
export const mockPayments: PaymentRecord[] = [
  ...
  },
  {
    ...
    method: "UPI",
    date: "Aug 17, 2026",
    txnId: "TXN20260817004",
  },
  {
    id: "PAY-005",
    seafarerId: "sf4",
    seafarerName: "Sandeep Nair",
    course: "Engine Room Operations",
    instituteId: "inst_2",
  ...
  },
  {
    ...
    seafarerId: "sf5",
    seafarerName: "Neha Sharma",
    course: "Medical First Aid at Sea",
    instituteId: "inst_2",
    instituteName: "Global Seafarers Academy",
    amount: 4500,
    status: "Paid",
    method: "UPI",
    date: "Aug 14, 2026",
    txnId: "TXN20260814006",
  },
  {
    id: "PAY-007",
    seafarerId: "sf1",
    seafarerName: "Capt. Rajesh Kumar",
    course: "Tanker Cargo Operations",
    instituteId: "inst_1",
    instituteName: "Hari Om Thalassic Maritime Training Institute",
    amount: 9400,
    status: "Pending",
  ...
  },
  {
    ...
    method: "UPI",
    date: "Aug 11, 2026",
    txnId: "TXN20260811009",
  },
  {
    id: "PAY-010",
    seafarerId: "sf4",
    seafarerName: "Sandeep Nair",
    course: "Maritime Law & Compliance",
    instituteId: "inst_4",
    instituteName: "Apex Marine Training",
    amount: 3200,
    status: "Overdue",
