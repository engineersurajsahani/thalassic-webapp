  ...
  return (
    <div className="blog-page">
      ...
      <section className="hero-section">
        <img
          src={require("../../assets/port-image.jpg")}
          ...
          <div className="articles-grid">
            ...
            <article className="article-card">
              <div className="article-image">
                <img src={require("../../assets/port-image.jpg")} alt="Maritime Safety" />
            ...
            <article className="article-card">
              <div className="article-image">
                <img src={require("../../assets/port-image.jpg")} alt="Port Operations" />
            ...
            <article className="article-card">
              <div className="article-image">
                <img src={require("../../assets/port-image.jpg")} alt="Green Shipping" />
            ...
            <article className="article-card">
              <div className="article-image">
                <img src={require("../../assets/port-image.jpg")} alt="Maritime Technology" />
            ...
            <article className="article-card">
              <div className="article-image">
                <img src={require("../../assets/port-image.jpg")} alt="Maritime Career" />
            ...
            <article className="article-card">
              <div className="article-image">
                <img src={require("../../assets/port-image.jpg")} alt="Digital Transformation" />
