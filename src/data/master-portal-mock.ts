...
export const MOCK_SEAFARERS: MockSeafarer[] = [
    ...
    documents: [
      {
        ...
        docNumber: "MUM-192847",
        validTill: "18 Aug 2029",
        verified: true,
      },
      {
        name: "STCW BST Certificate",
        docNumber: "BST-2022-819",
        validTill: "14 Jun 2027",
        verified: true,
      },
      {
        name: "Medical Fitness Certificate",
        docNumber: "MED-DG-9921",
  ...
  },
  {
    ...
    documents: [
      {
        name: "Continuous Discharge Certificate (CDC)",
        docNumber: "KOL-283910",
        validTill: "02 Mar 2028",
        verified: true,
      },
      {
        name: "Passport",
        docNumber: "T9281042",
        validTill: "19 Nov 2031",
        verified: true,
      },
    ],
    purchases: [
  ...
  },
  {
    ...
    documents: [
      {
        name: "Continuous Discharge Certificate (CDC)",
        docNumber: "CHN-492019",
        validTill: "25 May 2027",
        verified: true,
      },
      {
        name: "Medical Fitness Certificate",
        docNumber: "MED-DG-7192",
        validTill: "14 Feb 2024",
        verified: false,
      }, // expired medical
    ],
    purchases: [
  ...
  },
  {
    ...
    documents: [
      {
        name: "Continuous Discharge Certificate (CDC)",
        docNumber: "MUM-983210",
        validTill: "10 Oct 2029",
        verified: true,
      },
    ],
    purchases: [
  ...
  },
  {
    ...
    documents: [
      {
        name: "Continuous Discharge Certificate (CDC)",
        docNumber: "GOA-192019",
        validTill: "11 Nov 2025",
        verified: true,
      },
    ],
    purchases: [
...
export const MOCK_PARTNER_SETTLEMENTS: MockPartnerSettlement[] = [
  {
    ...
    purchases: [
      ...
      {
        seafarerName: "K. R. Varma",
        courseTitle: "Ship Navigation & Radar Simulation",
        amount: 6100,
        date: "15 Aug 2026",
      },
      {
        seafarerName: "Arjun Nair",
        courseTitle: "STCW Basic Safety Training",
        amount: 4600,
        date: "20 Aug 2026",
      },
