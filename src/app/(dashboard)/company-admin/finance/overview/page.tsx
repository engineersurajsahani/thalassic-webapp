...
const RevenueByInstituteBarChart = dynamic(
  () =>
    import("@/components/company-admin/charts/FinanceOverviewCharts").then(
      (m) => m.RevenueByInstituteBarChart,
    ),
  {
    ssr: false,
...
const CollectionDonutChart = dynamic(
  () =>
    import("@/components/company-admin/charts/FinanceOverviewCharts").then(
      (m) => m.CollectionDonutChart,
    ),
  {
    ssr: false,
    loading: () => <ChartSkeleton height="192px" />,
  },
);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className={`${card} p-6`}>
          ...
          <RevenueByInstituteBarChart data={byInstitute} dk={dk} mt={mt} />
        </div>
        ...
        <div className={`${card} p-6 flex flex-col justify-between`}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 my-auto">
            ...
            <CollectionDonutChart
              donutData={donutData}
              totalAmount={collectionStats.total}
              dk={dk}
            />
