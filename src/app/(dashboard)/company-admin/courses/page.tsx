    ...
    <div className="space-y-6 animate-fadeIn pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs opacity-60 mt-1">
            Browse available DG Shipping accredited courses, per-institute
            pricing, and assign training to crew.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl font-medium text-xs shadow-md transition-all hover:scale-[1.02] cursor-pointer ${
              isDark
      ...
      <div className="flex items-center justify-between px-1">
        <span className="text-xs font-medium opacity-60">
          ...
          {filteredCourses.length === 1 ? "course" : "courses"} in Course
          Catalog
        </span>
      </div>
      ...
      {filteredCourses.length === 0 ? (
        ...
        >
          ...
          <p className="text-xs opacity-50 mt-1">
            Try adjusting your selected category filter.
          </p>
        </div>
      ) : (
            ...
            return (
              <div
                ...
                className={`group relative rounded-2xl border p-5 transition-all duration-200 hover:-translate-y-1 hover:shadow-xl cursor-pointer flex flex-col justify-between ${
                  isDark
                    ? "bg-[#0B1528] border-white/10 hover:border-white/20 hover:shadow-black/40"
              ...
              >
                <div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-3">
                    <span
                      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[10px] font-bold tracking-wide uppercase border ${
                        isDark
                  ...
                  <p className="text-xs opacity-60 mt-2 line-clamp-2 leading-relaxed">
                    {course.description ||
                      "Comprehensive DG Shipping approved marine training module."}
                  </p>
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-4 pt-3 border-t border-white/5 text-xs">
                    ...
                    <div className="flex items-center gap-1.5 opacity-75">
                      <UsersIcon className="w-3.5 h-3.5 opacity-60 shrink-0" />
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                      isDark
                        ...
                        : "bg-[#263248] text-white hover:bg-[#1e2738]"
                    }`}
                  >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
          ...
          >
            ...
            <div className="p-6 space-y-6">
              {/* Description */}
              <div>
                <h4 className="text-xs font-semibold uppercase tracking-wider opacity-60 mb-2">
                  Course Overview
                </h4>
                {isEditing ? (
                  <textarea
              ...
              {isEditing && (
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-[10px] font-bold uppercase opacity-60 block mb-1.5">
                      Duration
                    </label>
                    <input
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-xs font-semibold uppercase tracking-wider opacity-60 flex items-center gap-1.5">
                      ...
                      {getCourseInstitutes(selectedCourse.title).length})
                    </h4>
          ...
          >
            ...
            {assignSuccessMessage ? (
              ...
              >
                {/* Select Course */}
                <div>
                  <label className="font-semibold block mb-1.5 opacity-80">
                    Select Course *
                  </label>
                  <select
                    required
                  ...
                  >
                    <option
                      value=""
                      disabled
                      className={isDark ? "bg-[#0B1528]" : "bg-white"}
                    >
                      Choose a Course...
                    </option>
                    {coursesList.map((c) => (
