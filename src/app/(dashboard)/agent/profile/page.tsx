  ...
  return (
    <div className="space-y-8 animate-fadeIn relative pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <section className={`${cardClasses} self-start`}>
          <h3 className={`text-sm font-black tracking-tight pb-4 mb-5 flex items-center gap-2 ${isDark ? "border-b border-slate-800/40" : "border-b border-slate-200"}`}>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <span className={`text-[10px] font-bold uppercase tracking-wider ${isDark ? "text-slate-500" : "text-slate-400"}`}>Referral Code</span>
              <span className="text-xs font-mono font-black">{formData.referralCode || "N/A"}</span>
            </div>
