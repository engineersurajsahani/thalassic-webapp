        ...
        <form onSubmit={handleStep1Submit} className={`p-6 md:p-8 space-y-6 ${cardBg}`}>
          ...
          <div className={`flex justify-end pt-4 border-t ${isDark ? "border-[#1F2937]" : "border-[#E5E7EB]"}`}>
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2.5 rounded-lg text-xs font-bold bg-[#3D5EF6] hover:bg-[#2E4FE0] text-white shadow-sm flex items-center gap-2 transition-colors cursor-pointer"
            >
          ...
          <div className={`p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 ${cardBg}`}>
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-bold uppercase tracking-widest px-3 py-0.5 rounded-lg bg-[#EEF1FE] text-[#3D5EF6] dark:bg-[#3D5EF6]/15">
