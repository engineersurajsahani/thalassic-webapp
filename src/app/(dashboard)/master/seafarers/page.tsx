                          ...
                          <div className="relative">
                            <button
                              ...
                              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold border transition-colors ${
                                dk ? "bg-white/5 border-white/10 text-white/70 hover:bg-white/10" : "bg-slate-100 border-slate-200 text-slate-700 hover:bg-slate-200"
                              }`}
                            >
                            ...
                            {openDropdown === s.id && (
                              <>
                                ...
                                <div className={`absolute right-0 mt-1 w-44 rounded-xl shadow-xl border z-20 py-1 ${dk ? "bg-[#0c1a2e] border-white/10" : "bg-white border-slate-200"}`}>
                                  <button
                                    onClick={e => { e.stopPropagation(); setOpenDropdown(null); openProfile(s); }}
                                  ...
                                  >
                                    <Eye className="w-3.5 h-3.5 text-sky-400" /> View Profile
                                  </button>
                                  <button
                                    onClick={e => { e.stopPropagation(); setOpenDropdown(null); openDocuments(s); }}
                                    className={`w-full flex items-center gap-2.5 px-3.5 py-2 text-xs font-semibold transition-colors ${dk ? "text-white/70 hover:bg-white/8 hover:text-white" : "text-slate-700 hover:bg-slate-50"}`}
                                  >
                                    <FileText className="w-3.5 h-3.5 text-emerald-400" /> View Documents
                                  </button>
                                </div>
                              </>
                            )}
