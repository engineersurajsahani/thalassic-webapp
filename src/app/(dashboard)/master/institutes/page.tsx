...
export default function InstitutesManagementPage() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: institutes.reduce((acc, i) => acc + i.activeBatches, 0),
      Icon: BookOpen,
      color: "bg-sky-500/15",
      ic: "text-sky-400",
    },
    {
      ...
      value: institutes
        .reduce((acc, i) => acc + i.totalCandidatesTrained, 0)
        .toLocaleString(),
      Icon: Users,
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className={`text-sm mt-0.5 ${mt}`}>
            Manage DG Shipping approved maritime training institutes, academies,
            and course centers
          </p>
        </div>
      ...
      <div className={card}>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className={thCls}>
                <th className="text-left px-6 py-3.5 text-[10px] font-semibold uppercase tracking-wider">
                  Institute
                </th>
                ...
                <th className="text-center px-4 py-3.5 text-[10px] font-semibold uppercase tracking-wider">
                  Batches
                </th>
                <th className="text-left px-4 py-3.5 text-[10px] font-semibold uppercase tracking-wider">
                  Status
              ...
              {filtered.map((i) => {
                ...
                return (
                  <tr key={i.id} className={`${rh} transition-colors`}>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className={`text-[11px] ${mt}`}>
                            Rating: ★ {i.rating} · Since {i.accreditedSince}
                          </p>
                        </div>
                      </div>
                    </td>
                    <td className="px-4 py-4">
                      <p className={`text-xs font-mono font-semibold ${ht}`}>
                        {i.code}
                      </p>
                    ...
                    <td className="px-4 py-4">
                      <span
                        className={`inline-flex items-center gap-1.5 text-[11px] font-semibold ${S.cls}`}
                      >
        ...
        {/* Footer */}
        <div
          className={`px-6 py-3 border-t text-xs ${mt} ${dk ? "border-white/5" : "border-slate-100"}`}
        >
      ...
      {modalMode && (
        ...
        >
          ...
          >
            <div
              className={`px-6 py-4 flex items-center justify-between border-b ${dk ? "border-white/8" : "border-slate-100"}`}
            >
              ...
              <button
                onClick={closeModal}
                className={`p-1.5 rounded-lg ${dk ? "hover:bg-white/10 text-white/40" : "hover:bg-slate-100 text-slate-400"}`}
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
              <div>
                <label
                  className={`block text-xs font-semibold mb-1.5 ${dk ? "text-white/70" : "text-slate-600"}`}
                >
                  Institute Name
                </label>
                <input
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setForm((f) => ({
                        ...f,
                        status: e.target.value as Institute["status"],
                      }))
                    }
                    className={`w-full px-3 py-2 text-sm rounded-lg border ${inputCls}`}
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((f) => ({
                        ...f,
                        activeBatches: parseInt(e.target.value) || 0,
                      }))
                    }
                    className={`w-full px-3 py-2 text-sm rounded-lg border ${inputCls}`}
                  />
            ...
            <div
              className={`px-6 py-4 border-t flex items-center justify-end gap-3 ${dk ? "border-white/8" : "border-slate-100"}`}
            >
              <button
                onClick={closeModal}
