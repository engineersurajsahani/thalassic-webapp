                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-1">
                        <button
                          ...
                          title="View Course & Institute Associations"
                          className={`p-1.5 rounded-lg transition-colors ${dk ? "hover:bg-white/8 text-white/40 hover:text-indigo-400" : "hover:bg-slate-100 text-slate-400 hover:text-indigo-600"}`}
                        >
                        ...
                        <button
                          ...
                          title="Edit Course"
                          className={`p-1.5 rounded-lg transition-colors ${dk ? "hover:bg-white/8 text-white/40 hover:text-amber-400" : "hover:bg-slate-100 text-slate-400 hover:text-amber-600"}`}
                        >
