...
export default function PlacementsPage() {
  ...
  return (
    <section className={`min-h-screen transition-colors duration-500 font-outfit ${
      isDark ? "bg-[#050a14] text-slate-100" : "bg-[#f8fafc] text-slate-900"
    }`}>
      <div className="max-w-7xl mx-auto px-6 pt-[140px] pb-24">
        ...
        <div className="text-center">
          <ScrollReveal>
            ...
            <h1 className={`mt-6 text-4xl sm:text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r ${
            ...
            <p className={`mt-6 max-w-2xl mx-auto text-sm leading-relaxed font-light ${
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-16">
          ...
          <ScrollReveal delay={100}>
            <div className={`rounded-3xl border p-8 shadow-xl transition-all duration-500 hover:scale-[1.02] h-full flex flex-col justify-between ${
              isDark
              ...
              <div>
                <div className={`p-3 rounded-2xl w-fit mb-6 ${
                  isDark ? "bg-slate-900/60 border border-slate-700/20 text-blue-300" : "bg-blue-50 text-blue-600 border border-blue-100"
                }`}>
