...
export default function AboutUsPage() {
  ...
  return (
    <div className={`transition-colors duration-500 min-h-screen font-outfit ${
      ...
      {/* 22. Partner With Us Today — full-screen CTA */}
      <section className="relative min-h-screen flex flex-col justify-center text-center overflow-hidden bg-[#0F1B2D]">
        {/* Decorative radial glow */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_50%,rgba(6,182,212,0.06),transparent)] pointer-events-none" />
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-cyan-500/40 to-transparent" />

        <div className="max-w-4xl mx-auto px-6 py-24 relative z-10 w-full">
          <ScrollReveal>
            <div className="mb-6">
              <span className="inline-block text-xs font-black uppercase tracking-widest text-cyan-400 border border-cyan-500/30 bg-cyan-500/5 rounded-full px-4 py-1.5 mb-6">
                Strategic Maritime Partnership
              </span>
            </div>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-white mb-5 leading-tight">
              Partner With Us Today
            </h2>
            <p className="text-base md:text-lg font-light text-slate-300 max-w-2xl mx-auto mb-16 leading-relaxed">
              Building a seamless, 100% compliant documentation ecosystem for your fleet seafarers.
            </p>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Registered Address */}
            <ScrollReveal delay={100}>
              <div className="p-8 rounded-2xl border border-slate-700/60 bg-[#162032] text-center flex flex-col items-center gap-4 h-full hover:border-cyan-500/40 transition-colors duration-300">
                <div className="w-12 h-12 rounded-full bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center">
                  <Building2 className="w-6 h-6 text-cyan-400" />
                </div>
                <div className="space-y-2">
                  <h4 className="text-base font-black text-white">Registered Address</h4>
                  <p className="text-sm font-light text-slate-300 leading-relaxed">
                    Office No. 9 &amp; 39, Mehta Chambers,<br />
                    Kalyan Street, Dana Bandar,<br />
                    Masjid Bandar (East), Mumbai,<br />
                    Maharashtra - 400009
                  </p>
                </div>
              </div>
            ...
            <ScrollReveal delay={200}>
              <div className="p-8 rounded-2xl border border-slate-700/60 bg-[#162032] text-center flex flex-col items-center gap-4 h-full hover:border-cyan-500/40 transition-colors duration-300">
                ...
                <div className="space-y-2">
                  <h4 className="text-base font-black text-white">Email Contact</h4>
                  <a href="mailto:support@hariomthalassic.com" className="text-sm font-light text-slate-300 hover:text-cyan-300 transition-colors block">
                    support@hariomthalassic.com
                  </a>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={300}>
              <div className="p-8 rounded-2xl border border-slate-700/60 bg-[#162032] text-center flex flex-col items-center gap-4 h-full hover:border-cyan-500/40 transition-colors duration-300">
                ...
                <div className="space-y-2">
                  <h4 className="text-base font-black text-white">Call / WhatsApp</h4>
                  <p className="text-sm font-light text-slate-300 leading-relaxed">
                    +91 8286833338<br />+91 7666705007
                  </p>
                </div>
              </div>
            </ScrollReveal>
          ...
          <ScrollReveal delay={400}>
            <p className="mt-16 text-xs font-light text-slate-500 tracking-wider uppercase">
              Hari Om Thalassic — Assistance at Sea, Support on Land.
            </p>
          </ScrollReveal>
        </div>
      </section>
