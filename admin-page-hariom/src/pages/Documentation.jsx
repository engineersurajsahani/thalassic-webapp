...
import { Users, CheckCircle, DollarSign, Award, FileText, Plus, Download, Search, Eye, Edit } from "lucide-react";
...
const Documentation = () => {
  ...
  const tasks = [
    {
      title: "PROCESS DG APPROVED MEDICAL CERTIFICATE",
      description: "",
    ...
    {
      title: "VERIFY SEAFARER ELIGIBILITY DOCUMENT",
      description: "",
      assignee: "Captain John Doe",
      date: "",
      status: "ongoing" 
  ...
  const documentOverview = [
    {
      documentType: "Seafarer Medical Certificate",
    ...
    {
      documentType: "Certificate of Competency",
      applicant: "Alex Mishra",
          ...
          <main className="p-8">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-xl font-semibold text-foreground">Documentation Administrator - DG Approved</h1>
              </div>
            ...
            {/* Task List Section */}
            <div className="mb-8">
              <h2 className="text-lg font-semibold text-foreground mb-4">Task List - DG Documentation Administrator</h2>
            ...
            {/* DG Documentation Overview */}
            <div>
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-foreground">DG Documentation Overview</h2>
